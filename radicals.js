...
const WORKER_WORDS_R = (window.TSUNDOKU_CONFIG && window.TSUNDOKU_CONFIG.workerWordsEndpoint) || "https://minireader.zoe-caudron.workers.dev/";
...
async function loadElementIndex() {
  ...
  const url = new URL("element2kanji.json", window.location.href).toString();
  try {
